...
// shirt, orange hi-vis vest, dark trousers, holding rolled blueprints / a light
// baton. Built from primitives and procedurally animated per state. Big-head
// chibi proportions so it reads clearly at small sizes.
const SKIN = '#f3c9a3', SKIN_D = '#e0ad82'
const HAT = '#f4c20d', HAT_D = '#d4a200'
const SHIRT = '#ffffff', SLEEVE_D = '#e8edf3'
const VEST = '#f97316', STRIPE = '#e2e8f0'
