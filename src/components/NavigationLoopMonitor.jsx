...
// Diagnostic: detects a redirect/navigation loop (the cause of Chrome's
// "Throttling navigation to prevent the browser from hanging" warning) and
// logs the offending route cycle, which the browser warning itself never
// reveals. Purely observational — it never navigates or changes app state.
