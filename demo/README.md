# Tutorial video harness — hecp-loto

Regenerates the screen-recorded tutorial (`hecp-loto.mp4`) by driving the **real app**
...
```
The video is written to `demo/out/hecp-loto.mp4`.
